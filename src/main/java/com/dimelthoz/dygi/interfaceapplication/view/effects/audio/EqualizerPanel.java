...
package com.dimelthoz.dygi.interfaceapplication.view.effects.audio;
...
import com.dimelthoz.dygi.interfaceapplication.view.SliderControl;
import com.dimelthoz.dygi.interfaceapplication.view.StandardLabel;
...
public class EqualizerPanel extends BasePanel implements ChangeListener, ItemListener, ActionListener {
    ...
    public final void actionPerformed(ActionEvent e) {
        ...
        Application.application().mediaPlayer().audio().setEqualizer(enable ? equalizer : null);
