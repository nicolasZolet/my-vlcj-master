...
final class AboutDialog extends JDialog {
    ...
    AboutDialog(Window owner) {
        ...
        nativeLibraryPathLabel.setText(Application.resources().getString("dialog.about.nativeLibraryPath"));

        JLabel nativeLibraryPathValueLabel = new ValueLabel();
        nativeLibraryPathValueLabel.setText(Application.application().mediaPlayerComponent().mediaPlayerFactory().nativeLibraryPath());

        JLabel vlcVersionValueLabel = new ValueLabel();
        vlcVersionValueLabel.setText(Application.application().mediaPlayerComponent().mediaPlayerFactory().application().version());

        JLabel vlcChangesetValueLabel = new ValueLabel();
        vlcChangesetValueLabel.setText(Application.application().mediaPlayerComponent().mediaPlayerFactory().application().changeset());
