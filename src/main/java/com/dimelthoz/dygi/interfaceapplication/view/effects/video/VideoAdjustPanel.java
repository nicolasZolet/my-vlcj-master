...
package com.dimelthoz.dygi.interfaceapplication.view.effects.video;
...
import com.dimelthoz.dygi.interfaceapplication.view.BasePanel;
...
public class VideoAdjustPanel extends BasePanel {
    ...
    public VideoAdjustPanel() {
        ...
        enableCheckBox = new JCheckBox(Application.resources().getString("dialog.effects.tabs.video.adjust.enable"));

        hueLabel = new JLabel();
        hueLabel.setText(Application.resources().getString("dialog.effects.tabs.video.adjust.hue"));
        ...
        brightnessLabel.setText(Application.resources().getString("dialog.effects.tabs.video.adjust.brightness"));
        ...
        contrastLabel.setText(Application.resources().getString("dialog.effects.tabs.video.adjust.contrast"));
        ...
        saturationLabel.setText(Application.resources().getString("dialog.effects.tabs.video.adjust.saturation"));
        ...
        gammaLabel.setText(Application.resources().getString("dialog.effects.tabs.video.adjust.gamma"));
