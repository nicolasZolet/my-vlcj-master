...
package com.dimelthoz.dygi.interfaceapplication.view.messages;
...
public final class NativeLogFrame extends BaseFrame implements LogEventListener {
    ...
    public NativeLogFrame(NativeLog nativeLog) {
        ...
        levelLabel.setText(Application.resources().getString("dialog.messages.level"));
        ...
        filterLabel.setText(Application.resources().getString("dialog.messages.filter"));
