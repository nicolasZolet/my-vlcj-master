...
package com.dimelthoz.dygi.interfaceapplication.view.action;
...
public final class Resource {
    ...
    public String name() {
        if (Application.resources().containsKey(id)) {
    ...
    public Integer mnemonic() {
        ...
        if (Application.resources().containsKey(key)) {
            return Integer.valueOf(Application.resources().getString(key).charAt(0));
        }
        else {
            return null;
        }
    ...
    public KeyStroke shortcut() {
        ...
        if (Application.resources().containsKey(key)) {
            return KeyStroke.getKeyStroke(Application.resources().getString(key));
        }
        else {
            return null;
        }
    ...
    public Icon menuIcon() {
        ...
        if (Application.resources().containsKey(key)) {
            return new ImageIcon(getClass().getResource("/icons/actions/" + Application.resources().getString(key) + ".png"));
        }
        else {
            return null;
        }
    ...
    public Icon buttonIcon() {
        ...
        if (Application.resources().containsKey(key)) {
            return new ImageIcon(getClass().getResource("/icons/buttons/" + Application.resources().getString(key) + ".png"));
        }
        else {
            return null;
        }
